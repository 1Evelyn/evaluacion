        ...
        <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
          ...
          <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
            <div class="navbar-nav mr-auto">
              <a href="<?php echo site_url(); ?>" id="menu_inicio" class="nav-item nav-link"><i class="fa fa-home"></i>&nbsp;&nbsp;Evelyn Jackeline Aimacaña Jaque-&nbsp;&nbsp;<br>CLOUD,ARQUITECTURA Y SEGURIDAD DE LOS S.I.<br>21/JULIO/2022 </a>
